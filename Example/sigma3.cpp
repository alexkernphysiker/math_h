...
int main()
{
    ...
    Plot("sigma3-example").Hist<1>(result,"","sigma3-output");//draws one error bar
    Plot("sigma3-example-2").Hist(wrap_hist(result));//calculates one uncertainty taking statistical and systematical errors into account
    return 0;
}
