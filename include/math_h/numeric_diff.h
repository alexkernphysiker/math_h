...
{
    template<class numt>
    inline Opr<numt,FunctionWrap<numt,const numt&>> num_der1(const numt&x,const numt&delta){
		return Opr<numt,FunctionWrap<numt,const numt&>>([x,delta](const FunctionWrap<numt,const numt&>&F){
    ...
    inline Opr<numt,FunctionWrap<numt,const numt&>> num_der2(const numt&x,const numt&delta){
		return Opr<numt,FunctionWrap<numt,const numt&>>([x,delta](const FunctionWrap<numt,const numt&>&F){
	...
	namespace numeric_diff_details{
		...
		Vector<index,Opr<numt,FunctionWrap<numt,const Vector<size,numt>&>>> 
		___nabla_partial(const Vector<size,numt>&X,const numt&delta){
